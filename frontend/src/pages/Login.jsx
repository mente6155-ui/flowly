  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f1117', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Inter', sans-serif", position: 'relative', overflow: 'hidden' }}>
      <style>{`
        ...
        .login-btn:hover { box-shadow: 0 0 30px rgba(99,102,241,0.5) !important; transform: translateY(-1px); }
      ...
      <div style={{ width: '100%', maxWidth: '420px', padding: '40px', borderRadius: '20px', background: '#1a1d27', border: '1px solid rgba(255,255,255,0.06)', boxShadow: '0 25px 50px rgba(0,0,0,0.5)', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ color: 'white', fontSize: '24px', fontWeight: 700, margin: '0 0 8px', textAlign: 'center' }}>Bienvenido de vuelta</h1>
          <p style={{ color: '#64748b', fontSize: '14px', margin: 0, textAlign: 'center' }}>Ingresá a tu Command Center</p>
        </div>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
              <label style={{ fontSize: '13px', fontWeight: 500, color: '#94a3b8' }}>Contraseña</label>
              <a href="#" style={{ fontSize: '12px', color: '#6366f1', textDecoration: 'none', fontWeight: 500 }}>¿Olvidaste tu contraseña?</a>
            </div>
            <input
              type="password"
              value={password}
        ...
        <p style={{ textAlign: 'center', fontSize: '13px', color: '#475569', marginTop: '24px', marginBottom: 0 }}>
          ¿No tenés cuenta?{' '}
          <span onClick={(e) => { e.preventDefault(); navigate('/register'); }} style={{ color: '#6366f1', fontWeight: 600, textDecoration: 'none', cursor: 'pointer' }}
      ...
      <div style={{ position: 'absolute', bottom: '24px', display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <span style={{ fontSize: '12px', color: '#475569' }}>All systems operational · 99.99% uptime</span>
      </div>
    </div>
  )
}
